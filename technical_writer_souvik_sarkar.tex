...
\address{\bf \href{mailto:sounix000@gmail.com}{sounix000@gmail.com} \\ (+91) 6360229130 \\ \href{https://sounix000.github.io/technical-writing-samples/}{Portfolio} } % Your email, phone number, and portfolio
...
\item \underline{Technologies/Tools}: macOS, JavaScript (Node.js, Vue.js, React.js), VS Code, Vim, Markdown, Lucidchart, GitHub, Trello
\end{rSubsection}
...
\item \underline{Technologies/Tools}: Ubuntu Linux, Python (Django, Flask), JavaScript (Node.js, React.js), Google Cloud Platform (App Engine), Sublime Text, Vim
\end{rSubsection}
...
\item \underline{Technologies/Tools}: Ubuntu Linux, Python, JavaScript, Sublime Text
\end{rSubsection}
